				...
				<view class="chart-container">
					<view class="title">
						...
						<uni-data-select v-model="value_time5" :localdata="division_time" @change="bindPickerChange5"
							:clear="false" placeholder="请选择时间" class="uni-list-cell-picker"
	...
	export default {
		...
		methods: {
			...
			getList7() {
				...
				this.$api.getDepartmentWorkloadFromCache.post(this.List3_obj).then(response => {
					// console.log(response)
